-- Zain Ice Hub - Complete Supabase Schema

-- 1. Create Users Table (for staff and admin credentials)
...
-- 3. Create Shifts Table (for drawer session management)
...
-- 4. Create Sales Table (linked to products and optional active shifts)
